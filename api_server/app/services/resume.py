...
# Extract address, contact info for job recommendations
def extract_address(text: str):
    # Use regex to find potential addresses in the text
    address_pattern = r'\d{1,5}\s\w+\s\w+.*'  # Simple pattern for addresses depending on area, can be improved
...
if __name__ == "__main__":
    ...
    skills_ai = extract_skills_with_ai(resume_text)
