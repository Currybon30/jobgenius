...
from app.routers.resume_router import JOB_FINDER_RESET_WINDOW, PREMIUM_ANALYZER_RESET_WINDOW
import pymupdf
...
async def analyze_resume_premium(
    ...
    try:
        ...
        await redis_client.setex(f"resume_analysis:{job_id}:result", 60 * 60 * 24, results_json)  # Store for 24 hours
